[CmdletBinding()]
param(
    [string]$ConfigFile = '.github/skills-config/ebook-build/github-copilot-custom-agents-tutorial.build.json'
)
...
$chapterFilePattern = if ($chapterFilePatternValue) { [string]$chapterFilePatternValue } else { '^.*\.md$' }
