...
[![Deploy docs to GitHub Pages](https://github.com/duwenji/github-copilot-custom-agents-tutorial/actions/workflows/pages.yml/badge.svg)](https://github.com/duwenji/github-copilot-custom-agents-tutorial/actions/workflows/pages.yml)
[![GitHub Release](https://img.shields.io/github/v/release/duwenji/github-copilot-custom-agents-tutorial)](https://github.com/duwenji/github-copilot-custom-agents-tutorial/releases/tag/v0.3.0)
...
5. 必要なら `npm install` 後に `npm run ebook:build` を使う

### 10分で試す

- まずは `docs-writer.agent.md` を読む
- 次に `Part 0` と `Part 1` を確認する
- 最後に GitHub Pages 版をブラウザで開いて全体像をつかむ
...
- `release-prep.agent.md` — 公開前チェックとリリース準備向け
- `release-readiness/SKILL.md` — 公開前の標準確認フローを再利用する Skill
...
- [Part 3-7: サンプル4 - Release Prep + Skill 連携](docs/03-implementation/07-sample-release-prep-agent.md)
...
- [Part 4-5: FAQ](docs/04-operations/05-faq.md)
...
- ✅ `ebook-build` 向けの設定ファイルを追加
- ✅ Agent + Skill 連携の新サンプルを追加
- 🔄 章本文をさらに拡充中
- 🔄 将来的に ebook 出力や公開導線をさらに改善予定
