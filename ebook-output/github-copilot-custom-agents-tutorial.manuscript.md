# GitHub Copilot Custom Agents {#cover-00-cover}
...
# 第0章 Fundamentals {#chapter-00-fundamentals}

## 0.0 Part 0: `.agent.md` の位置づけ {#section-00-fundamentals-00-agent-format-overview}
...
## 0.4 Part 0-4: Customization Map {#section-00-fundamentals-04-customization-map}
...
## 1.1 Part 1-1: カスタムエージェントとは {#section-01-basics-01-introduction}


### 1.1.1 カスタムエージェントが解決する問題
...
## 1.2 Part 1-2: Skills との違い {#section-01-basics-02-vs-skills}
...
## 1.3 Part 1-3: カスタムエージェントの動き方 {#section-01-basics-03-how-custom-agents-work}
...
## 2.1 Part 2-1: 通常プロンプトとの違い {#section-02-comparison-01-vs-prompts}
...
## 2.2 Part 2-2: Skills / MCP との違い {#section-02-comparison-02-vs-skills-and-mcp}
...
## 2.3 Part 2-3: どれを選ぶべきか {#section-02-comparison-03-selection-guide}
...
#### 2.3.2.1 パターン1: 小さく始める
- `copilot-instructions.md`
- `docs-writer.agent.md`

#### 2.3.2.2 パターン2: 手順も共有する
- `copilot-instructions.md`
- `debug-helper.agent.md`
- `SKILL.md`

#### 2.3.2.3 パターン3: 実務連携まで広げる
- `copilot-instructions.md`
...
## 3.1 Part 3-1: 最初のエージェントを作る {#section-03-implementation-01-getting-started}
...
### 3.1.3 Step 2: 最小 frontmatter を書く
...
## 3.2 Part 3-2: エージェント定義の読み方 {#section-03-implementation-02-agent-structure}
...
## 3.3 Part 3-3: サンプル1 - Docs Writer Agent {#section-03-implementation-03-sample-docs-agent}
...
## 3.4 Part 3-4: サンプル2 - Debug Helper Agent {#section-03-implementation-04-sample-debug-agent}
...
## 3.5 Part 3-5: サンプル3 - Repo Maintainer Agent {#section-03-implementation-05-sample-repo-agent}
...
## 3.6 Part 3-6: Agent をどう評価するか {#section-03-implementation-06-agent-evaluation}
...
## 3.7 Part 3-7: サンプル4 - Release Prep + Skill 連携 {#section-03-implementation-07-sample-release-prep-agent}
...
# 第4章 Operations {#chapter-04-operations}

## 4.1 Part 4-1: ベストプラクティスとアンチパターン {#section-04-operations-01-best-practices}
...
#### 4.1.1.2 `description` を具体的にする
- 「いつ使うか」を文章で書く
- README、debug、broken build などのキーワードを含める

#### 4.1.1.3 `tools` は最小限にする
...
#### 4.1.2.1 Swiss-army agent
何でもできる 1体にしようとして、責務が曖昧になるパターンです。

#### 4.1.2.2 曖昧な description
...
## 4.2 Part 4-2: Agent レビュー・チェックリスト {#section-04-operations-02-review-checklist}
...
## 4.3 Part 4-3: Packaging と公開準備 {#section-04-operations-03-packaging-and-publishing}
...
## 4.4 Part 4-4: 公開前チェックリスト {#section-04-operations-04-release-checklist}
...
## 4.5 Part 4-5: FAQ {#section-04-operations-05-faq}


### 4.5.1 Q1. Custom Agent と Skill はどちらを先に作るべきですか？
...
### 4.5.2 Q2. `description` はどのくらい具体的に書くべきですか？
...
## 5.1 Part 5-1: Subagents と Handoffs {#section-05-advanced-topics-01-subagents-and-handoffs}
...
## 5.2 Part 5-2: チーム向け設計パターン {#section-05-advanced-topics-02-team-design-patterns}
...
## 5.3 Part 5-3: Orchestrator Agent の例 {#section-05-advanced-topics-03-orchestrator-example}
...
#### 5.3.1.2 ■ `tutorial-orchestrator.agent.md` の設計・進め方（展開）
